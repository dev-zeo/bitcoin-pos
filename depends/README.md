...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_zeo` executable (see https://github.com/dev-zeo/zeo/pull/13543),
...
options will be passed to zeo's configure. In this case, `--disable-wallet`.
