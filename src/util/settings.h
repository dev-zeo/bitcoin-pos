// Copyright (c) 2019-2020 The coinBit Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ZEO_UTIL_SETTINGS_H
#define ZEO_UTIL_SETTINGS_H
...
//!       https://github.com/zeo/zeo/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored zeo settings. This struct combines settings from the command line
