...
#ifndef ZEO_SCRIPT_STANDARD_H
#define ZEO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a zeo address
 */
...
/**
 * Generate a Zeo scriptPubKey for the given CTxDestination. Returns a P2PKH
