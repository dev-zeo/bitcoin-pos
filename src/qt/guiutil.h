...
#ifndef ZEO_QT_GUIUTIL_H
#define ZEO_QT_GUIUTIL_H
...
/** Utility functions used by the Zeo Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "zeo:" URI into recipient object, return true on successful parsing
