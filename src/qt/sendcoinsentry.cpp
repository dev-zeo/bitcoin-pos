    ...
    platformStyle(_platformStyle)
{
    ...
    // normal zeo address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying zeo address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ZeoAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
