    ...
    mapper(nullptr)
{
    ...
    ui->zeoAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->zeoAtStartup);
    ...
    ui->zeoAtStartup->setToolTip(ui->zeoAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->zeoAtStartup->setText(ui->zeoAtStartup->text().arg(PACKAGE_NAME));

    ui->openZeoConfButton->setToolTip(ui->openZeoConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ZeoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->zeoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openZeoConfButton_clicked()
{
