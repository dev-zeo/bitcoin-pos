...
#include <config/zeo-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatZeoURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ZeoUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatZeoURI(info));
}
