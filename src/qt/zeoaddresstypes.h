...
#ifndef ZEO_QT_ZEOADDRESSTYPES_H
#define ZEO_QT_ZEOADDRESSTYPES_H
...
/** Zeo adress type definitions. Encapsulates parsing
   and serves as list model for drop-down selection boxes.
*/
class ZeoAddressTypes: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZeoAddressTypes(QObject *parent);
...
typedef ZeoAddressTypes::AddressType ZeoAddressType;

#endif // ZEO_QT_ZEOADDRESSTYPES_H
