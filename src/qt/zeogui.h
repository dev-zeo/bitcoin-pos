...
#ifndef ZEO_QT_ZEOGUI_H
#define ZEO_QT_ZEOGUI_H
...
/**
  Zeo GUI main class. This class represents the main window of the Zeo UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ZeoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ZeoGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~ZeoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a zeo wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
