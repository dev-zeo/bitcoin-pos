...
//! Entry point for ZeoApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ZeoApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ZeoGUI tests.
void AppTests::guiTests(ZeoGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ZeoGUI::consoleShown, this, &AppTests::consoleTests);
