...
#ifndef ZEO_TEST_SCRIPTNUM10_H
#define ZEO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Zeo Core 0.10.0, for cross-comparison.
 */
public:
