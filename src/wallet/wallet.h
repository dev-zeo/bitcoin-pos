...
#ifndef ZEO_WALLET_WALLET_H
#define ZEO_WALLET_WALLET_H
...
public:
     ...
     * on this zeo node, and set to 0 for transactions that were created
...
private:
    ...
    void StakeZEOs(bool fStake, CConnman* connman, CTxMemPool* mempool);
