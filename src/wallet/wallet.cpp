...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/dev-zeo/zeo/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/dev-zeo/zeo/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g zeo-wallet), lock can't be taken.
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/dev-zeo/zeo/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/dev-zeo/zeo/pull/9371 and the prior sync
        ...
        // https://github.com/zeo-core/zeo-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/dev-zeo/zeo/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-zeo-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g zeo-wallet), tx confirmation
 ...
 * https://zeotalk.org/?topic=54527, or
 * https://github.com/dev-zeo/zeo/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //ZEOTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeZEOs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeZEOs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeZEOs(true, connman, mempool);
}
