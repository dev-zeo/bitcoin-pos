...
#ifndef ZEO_WALLET_SCRIPTPUBKEYMAN_H
#define ZEO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Zeo Core wallet was originally a collection of unrelated private
...
#endif // ZEO_WALLET_SCRIPTPUBKEYMAN_H
