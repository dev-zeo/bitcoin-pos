// Copyright (c) 2015-2018 The coinBit Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ZEO_ZMQ_ZMQABSTRACTNOTIFIER_H
#define ZEO_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // ZEO_ZMQ_ZMQABSTRACTNOTIFIER_H
