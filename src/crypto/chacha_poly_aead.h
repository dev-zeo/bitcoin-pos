...
#ifndef ZEO_CRYPTO_CHACHA_POLY_AEAD_H
#define ZEO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@zeo.
 *
 ...
 *
 * The chacha20-poly1305@zeo combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@zeo cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@zeo are relatively fast in
...
#endif // ZEO_CRYPTO_CHACHA_POLY_AEAD_H
