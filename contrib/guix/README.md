# Bootstrappable Zeo Core Builds

This directory contains the files necessary to perform bootstrappable Zeo
Core builds.
...
- 24GB of free disk space on the partition that the Zeo Core git repository
  resides in
...
For a Zeo Core depends development environment, simply invoke
...
From the top of a clean Zeo Core repository:
...
To use dongcarl's substitute server for Zeo Core builds after having
