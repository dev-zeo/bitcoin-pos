...
(define* (make-zeo-cross-toolchain target
                                  #:key
...
desirable for building Zeo Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-zeo-cross-toolchain "i686-linux-gnu")
       (make-zeo-cross-toolchain "x86_64-linux-gnu")
       (make-zeo-cross-toolchain "aarch64-linux-gnu")
       (make-zeo-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-zeo-cross-toolchain "riscv64-linux-gnu"
