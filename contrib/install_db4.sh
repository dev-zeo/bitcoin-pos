...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the zeo repository."
  exit 1
fi
...
# See https://github.com/dev-zeo/zeo/issues/16064
...
echo 'When compiling zeod, run `./configure` in the following way:'
echo
