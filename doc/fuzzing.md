# Fuzzing Zeo Core using libFuzzer
...
The project's collection of seed corpora is found in the [`zeo-core/qa-assets`](https://github.com/zeo-core/qa-assets) repo.

To fuzz `process_message` using the [`zeo-core/qa-assets`](https://github.com/zeo-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/zeo-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`zeo-core/qa-assets`](https://github.com/zeo-core/qa-assets) repo.

Every single pull request submitted against the Zeo Core repo is automatically tested against all inputs in the [`zeo-core/qa-assets`](https://github.com/zeo-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Zeo Core more robust.
...
# Fuzzing Zeo Core using american fuzzy lop (`afl-fuzz`)
