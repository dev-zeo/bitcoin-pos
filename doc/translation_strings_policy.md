...
This document provides guidelines for internationalization of the Zeo Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zeo_en.ts` remains unchanged.
