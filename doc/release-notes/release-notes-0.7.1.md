Zeo version 0.7.1 is now available from:
  http://sourceforge.net/projects/zeo/files/Zeo/zeo-0.7.1/
...
* Clicking on a zeo: URI on Windows should now launch Zeo-Qt properly.
