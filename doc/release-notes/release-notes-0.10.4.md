Zeo Core version 0.10.4 is now available from:

  <https://zeo.org/bin/zeo-core-0.10.4/>
...
<https://github.com/zeo/zeo/pull/6351>
...
For more information, see: <https://github.com/zeo/zeo/pull/6917>
...
- #6953 `43c2789` Split zeo-tx into its own package
- #6953 `dfe0d4d` Include zeo-tx binary on Debian/Ubuntu
