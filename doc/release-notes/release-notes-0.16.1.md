Zeo Core version 0.16.1 is now available from:

  <https://zeocore.org/bin/zeo-core-0.16.1/>
...
- #12843 `df38b13` Test starting zeod with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure zeod processes are cleaned up when tests end (sdaftuar)
