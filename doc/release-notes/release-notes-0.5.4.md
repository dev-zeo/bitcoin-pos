Zeo version 0.5.4 is now available for download at:
http://sourceforge.net/projects/zeo/files/Zeo/zeo-0.5.4/
...
http://gitorious.org/zeo/zeod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Zeo-Qt notifications under Growl 1.3.
Increase required age of Zeo-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZeo properly when installing Zeo-Qt over it. (Windows)
