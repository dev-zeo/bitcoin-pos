Zeo-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/zeo/files/Zeo/zeo-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Zeo
...
New/changed settings (command-line or zeo.conf file)
--------------------------------------------------------
