Zeo Core version 0.13.2 is now available from:

  <https://zeo.org/bin/zeo-core-0.13.2/>
...
- #8908 `4a974b2` Update zeo-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow zeo-tx to create v2 transactions (ZEOdrak)
