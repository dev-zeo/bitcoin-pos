Download URL: https://sourceforge.net/projects/zeo/files/Zeo/zeo-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ZEO fee schedule (users still pay 0.01 ZEO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #zeo00 - #zeo99
