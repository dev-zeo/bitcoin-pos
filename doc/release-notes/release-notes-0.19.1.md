...
Zeo Core version 0.19.1 is now available from:

  <https://zeocore.org/bin/zeo-core-0.19.1/>
...
From Zeo Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Zeo Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Zeo Core does not yet change appearance when
...
- #17488 fix "zeod already running" warnings on macOS (fanquake)
