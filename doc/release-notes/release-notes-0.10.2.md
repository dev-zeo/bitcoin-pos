Zeo Core version 0.10.2 is now available from:

  <https://zeo.org/bin/zeo-core-0.10.2/>
...
characters (https://github.com/dev-zeo/zeo/issues/6078).

For other platforms there are no notable changes.

For the notable changes in 0.10, refer to the release notes
at https://github.com/dev-zeo/zeo/blob/v0.10.0/doc/release-notes.md
