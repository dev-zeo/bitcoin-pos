Zeo Core version 0.9.4 is now available from:

  https://zeo.org/bin/0.9.4/
...
this update is incompatible with the Zeo system and could lead to consensus
forks.

Zeo Core released binaries from https://zeo.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~zeo/+archive/ubuntu/zeo
- A third-party or self-compiled Zeo Core

upgrade to Zeo Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
