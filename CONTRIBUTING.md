Contributing to Zeo Core
============================

The Zeo Core project operates an open contributor model where anyone is
...
Most communication about Zeo Core development happens on IRC, in the
#zeo-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/zeo-core-dev/](http://www.erisian.com.au/zeo-core-dev/)
and [http://gnusha.org/zeo-core-dev/](http://gnusha.org/zeo-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/zeo-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to zeo-qt
...
The following applies to code changes to the Zeo Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Zeo
Network Protocol consensus changes.

Whether a pull request is merged into Zeo Core rests with the project merge
...
Patches that change Zeo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zeo consensus, it must have been
...
The project leader is the release manager for each Zeo Core release.
