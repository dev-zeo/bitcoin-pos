...
By default, zeod will dump mempool on shutdown and
...
class MempoolPersistTest(ZeoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent zeod from writing mempool.dat to disk. Verify that `savemempool` fails")
