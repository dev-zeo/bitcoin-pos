...
class P2PPermissionsTests(ZeoTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].zeoconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].zeoconf, 'w', encoding="utf8") as f:
            f.write(newText)
