...
"""Verify that starting zeo with -h works as expected."""

from test_framework.test_framework import ZeoTestFramework
from test_framework.util import assert_equal

class HelpTest(ZeoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zeo with -h for help text")
        ...
        self.log.info("Start zeo with -version for version information")
        ...
        self.log.info("Start zeod with -fakearg to make sure it does not start")
