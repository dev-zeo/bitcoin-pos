...
# Fee rates (in ZEO per 1000 vbytes)
...
class BumpFeeTest(ZeoTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 ZEO (100,000 satoshis)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Zeo to serialize ECDSA signatures means that signatures can have a
    ...
    # Bump with fee_rate of 0.00350250 ZEO per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 ZEO / 1000 vbytes = 0.00049385 ZEO.
    # or occasionally 140 vbytes * fee_rate 0.00350250 ZEO / 1000 vbytes = 0.00049035 ZEO.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 ZEO.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 ZEO / 1000 vbytes = 0.00002820 ZEO
